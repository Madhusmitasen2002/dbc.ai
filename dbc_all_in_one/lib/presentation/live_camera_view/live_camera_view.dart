...
class _LiveCameraViewState extends State<LiveCameraView>
  ...
  static const List<Map<String, Object>> _mockDetections = [
    {'type': 'person',  'confidence': 0.95, 'left': 60.0,  'top': 90.0,  'width': 80.0,  'height': 120.0},
  ...
  void _triggerAlert(String msg) {
    setState(() { _showAlert = true; _alertMessage = msg; });
  ...
  Widget _buildDetection(Map<String, Object> d) {
    ...
    return Positioned(
      left: d['left'] as double, top: d['top'] as double,
      child: Container(
        width: d['width'] as double, height: d['height'] as double,
        decoration: BoxDecoration(
